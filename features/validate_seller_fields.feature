...
Scenario: add book with invalid price
    When I add a book with title "Analog Electronic Design: Principles and Practice of Creative Design", author "Johnathan Scott", isbn "0123456789", and "Buy Now Price" "$99."
    Then I should see flash message "Price is invalid"
    
Scenario: add book with invalid auction_start_price
    When I add a book with title "Analog Electronic Design: Principles and Practice of Creative Design", author "Johnathan Scott", isbn "0123456789", and "Auction Price" "$99."
